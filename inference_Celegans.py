...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--cfg', type=str, default='aff_w10_graph_KD_T2_S-MobileNetV2_node0.1_edge1_CIaff1_CInode0_CIedge1_MSE_MS128_CS2_v7', help='path to config file')
    parser.add_argument('-mn', '--model_name', type=str, default='2022-12-30--05-16-46_baseline_emb16_mutex_MobileNetV2')
