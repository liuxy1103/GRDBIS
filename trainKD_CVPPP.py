'''
used for KD between 
t: NestedUNet, ResNet_T2, Segformer
s: ENet ESPNet MobileNetV2
'''
...
def build_model(cfg, writer):
    ...
    elif cfg.MODEL_T.model_type =='Segformer':
        model_T = Segformer(
...
def loop(cfg, train_provider, valid_provider, model, model_T, criterion, optimizer, iters, writer):
    ...
    # optimizer = torch.optim.Adam(params_list.parameters(), lr=cfg.TRAIN.base_lr, betas=(0.9, 0.999),
    ...
    while iters <= cfg.TRAIN.total_iters:
        ...
        # loss_aff_KD = torch.sum(((pred - pred_T)*weightmap*affs_mask.float()) ** 2)/norm_term * cfg.TRAIN.affinity_weight
        ...
        # loss_graph = loss_graph * cfg.TRAIN.graph_node_mutual_weight
        # loss_node = loss_node * cfg.TRAIN.graph_node_mutual_weight
        # loss_edge = loss_edge * cfg.TRAIN.graph_node_mutual_weight

        # t2 = time.time()
        # print('cost time of calculating loss:', t2 - t1)
        ...
        loss_CI_aff_KD = (loss_CI_aff_KD / cfg.TRAIN.contrast_size)*cfg.TRAIN.batch_size
        ...
        # loss_CI_graph = loss_CI_graph* cfg.TRAIN.CI_graph_node_mutual_weight
        # loss_CI_node = loss_CI_node* cfg.TRAIN.CI_graph_node_mutual_weight
        # loss_CI_edge = loss_CI_edge* cfg.TRAIN.CI_graph_node_mutual_weight
        # print('loss_CI_graph',loss_CI_graph)
