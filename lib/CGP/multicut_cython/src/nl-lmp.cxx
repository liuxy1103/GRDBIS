...
nl_lmp::Problem<GRAPH> make_problem(andres::View<double> const& unaries, andres::View<uint16_t> const& edges, andres::View<double> const& probabilities, bool do_logit_transform, bool with_suppression = false)
{
    ...
    for (size_t e = 0; e < edges.shape(0); ++e)
        if (edges(e, 0) != edges(e, 1))// and edges(e, 3)<numberOfClasses and edges(e, 2)<numberOfClasses)
        {
            auto p = probabilities(e);
	    //if (edges(e, 3)>numberOfClasses or edges(e, 2)>numberOfClasses)
	//	std::cout<<"...Warning:"<<"  c0: "<<edges(e, 2)<<"  c1: "<<edges(e, 3)<<std::endl;
	    //std::cout<<"...v0: "<<edges(e, 0)<<"  v1: "<<edges(e, 1)<<"  c0: "<<edges(e, 2)<<"  c1: "<<edges(e, 3)<<"  p: "<<p<<std::endl;
