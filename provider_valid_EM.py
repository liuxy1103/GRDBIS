...
class Provider_valid(Dataset):
    def __init__(self, cfg, valid_data=None, num_z=18, test=False, test_split=None):
        ...
        if valid_dataset_name == 'isbi_test':
            self.test_split = 100
        ...
        for k in range(len(self.train_datasets)):
            ...
            if valid_dataset_name == 'ac3' or valid_dataset_name == 'ac4':
                data = np.pad(data, ((15,15),(0,0),(0,0)), mode='constant')
            ...
            if valid_dataset_name == 'ac3' or valid_dataset_name == 'ac4':
                label = np.pad(label, ((15,15),(0,0),(0,0)), mode='constant')
